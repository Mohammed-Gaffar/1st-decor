       ...
       <div class="card">
           ...
           <div class="container-fluid">
               <div class="row justify-content-center">
                   <div class="col-12">
                       <h2 class="h3 mb-4 page-title">@lang('site.customer profile')</h2>
                       <div class="row mt-5 align-items-center">
                           <div class="col-md-3 text-center mb-5">
                               <div class="avatar avatar-xl">
{{--                                   <img src="{{asset('asset/avatars/face-1.jpg')}}" alt="..." class="avatar-img rounded-circle">--}}
                                   <img src="{{asset($customer_img->img_path)}}" alt="..." class="avatar-img rounded-circle">
                               </div>
                           </div>
                           <div class="col">
                               <div class="row align-items-center">
                                   <div class="col-md-7">
                                       ...
                                       <h3><p class="small mb-3"><span class="badge badge-dark">{{$customer->address}}</span></p></h3>
                                   </div>
                               </div>
                               <div class="row mb-4">
                                   <div class="col-md-7">
                                   ...
                                   <div class="col">
                                       <p class="small mb-0 text-muted">{{$customer->work_email}}</p>
                                       <p class="small mb-0 text-muted">{{$customer->work_phone}}</p>
                       ...
                       <div class="row my-4">
                          ...
                          <span class="circle circle-lg bg-light">
                            <i class="fe fe-user fe-24 text-primary"></i>
                                           ...
                                           <div class="col">
                                               <a href="#">
                                                   <h3 class="h5 mt-4 mb-1">@lang('site.personal info')</h3>
                                               </a>
                                               <p class="text-muted">the name is {{$customer->name}} <br> the company name {{$customer->company}}</p>
                                           </div> <!-- .col -->
                                       </div> <!-- .row -->
                                   </div> <!-- .card-body -->
                          ...
                          <span class="circle circle-lg bg-light">
                            <i class="fe fe-shield fe-24 text-primary"></i>
                                           ...
                                           <div class="col">
                                               <a href="#">
                                                   <h3 class="h5 mt-4 mb-1">@lang('site.contact info')</h3>
                                               </a>
                                               <p class="text-muted">the phone is {{$customer->work_phone}} <br> and the working phone is {{$customer->work_email}}</p>
                                           </div> <!-- .col -->
                                       </div> <!-- .row -->
                                   </div> <!-- .card-body -->
                                   <div class="card-footer">
                          ...
                          <span class="circle circle-lg bg-light">
                            <i class="fe fe-bell fe-24 text-primary"></i>
                                           ...
                                           <div class="col">
                                               <a href="#">
                                                   <h3 class="h5 mt-4 mb-1">@lang('site.numbers')</h3>
                                               </a>
                                               <p class="text-muted">{{$contacttimes}}</p>
                                           </div> <!-- .col -->
                                       </div> <!-- .row -->
                                   </div> <!-- .card-body -->
                                   <div class="card-footer">
