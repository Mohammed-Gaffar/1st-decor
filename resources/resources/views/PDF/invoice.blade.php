...
{{--            background: #ffffff url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='4' height='5' viewBox='0 0 4 5'><path fill='#343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/></svg>") no-repeat left 0.75rem center;--}}
...
{{--            min-width: 5rem;--}}
{{--            width: 5rem; }--}}
{{--        .rtl.vertical.collapsed .sidebar-left .navbar-nav .nav-link {--}}
{{--            text-align: center; }--}}
...
{{--            right: -1rem; }--}}
{{--        .rtl.vertical .sidebar-left .navbar-nav .nav-link, .rtl.vertical.hover .sidebar-left .navbar-nav .nav-link {--}}
{{--            text-align: right; }--}}
{{--        .rtl.vertical .topnav,--}}
...
{{--            .rtl.vertical.collapsed .sidebar-left .navbar-nav .nav-link {--}}
{{--                text-align: right; }--}}
{{--            .rtl.vertical.collapsed .sidebar-left .navbar-nav > .nav-item > ul.collapse {--}}
...
{{--                            <div class="col-auto">--}}
{{--                                <button type="button" class="btn btn-secondary" onclick="Popup('reportPrinting')">Print</button>--}}
{{--                                <button type="button" class="btn btn-primary">Pay</button>--}}
{{--                            </div>--}}
                        </div>
                        <div class="card shadow" id="reportPrinting">
                            <div class="card-body p-5">
                                <div class="row mb-5">
                                    <div class="col-12 text-center mb-4">
                                        <img src="public/company_img/logo.jpg" class="navbar-brand-img brand-sm mx-auto mb-4" alt="...">
